      ...
      <section className="value-props" style={{ paddingTop: 0 }}>
        <div className="container">
          <div className="about-prose article-body">
            ...
            <p>Cameron's office went on to partner directly with local officials in the hardest-hit counties, including Hopkins County, on ongoing efforts to prevent contractor scams as rebuilding continued into 2022.</p>
            ...
            <ul className="article-sources">
              <li><a href="https://finance.yahoo.com/news/kentucky-state-police-warns-tornado-163421767.html" target="_blank" rel="noopener noreferrer">Kentucky State Police Warns Tornado Victims About Scammers, Looters</a></li>
              <li><a href="https://www.wkyufm.org/regional/2022-01-12/kentucky-ag-partners-with-hopkins-county-officials-to-prevent-contractor-scams-after-tornadoes" target="_blank" rel="noopener noreferrer">WKYU — Kentucky AG Partners With Hopkins County Officials to Prevent Contractor Scams After Tornadoes</a></li>
              <li><a href="https://www.ag.ky.gov/Resources/Consumer-Resources/Pages/Natural-Disaster-Scams.aspx" target="_blank" rel="noopener noreferrer">Kentucky Attorney General — Natural Disaster Scams Consumer Resource</a></li>
              <li><a href="https://www.fema.gov/disaster/4630" target="_blank" rel="noopener noreferrer">FEMA — Kentucky Severe Storms and Tornadoes (DR-4630, background)</a></li>
            </ul>
          </div>
