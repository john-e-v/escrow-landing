    ...
    <>
      ...
      <section className="hero" style={{ paddingBottom: 40, paddingTop: 120 }}>
        <div className="container hero-content">
          ...
          <h1>The Omaha Contractors Who Took Storm Deposits and Vanished</h1>
          <p className="hero-subtitle">Two Omaha-area contractors collected deposits from homeowners for siding and roofing repairs after severe storms, then failed to complete the work or return the money. Authorities charged both after victims came forward with losses.</p>
        </div>
      </section>
      ...
      <section className="value-props" style={{ paddingTop: 0 }}>
        <div className="container">
          <div className="about-prose article-body">
            ...
            <p>Two Omaha-area cases show the pattern repeating with the same operators. Mark Schneidewind, doing business as Midwest Repairs and Midwest Restorations, was arrested on felony theft-by-deception warrants for taking storm-related roof-repair payments without completing the work — after a prior 2023 conviction for the identical conduct. Separately, roofing company owner Joshua Peterson entered a no-contest plea to felony attempted theft by deception involving an Omaha homeowner.</p>
            ...
            <ul className="article-sources">
              <li><a href="https://www.wowt.com/2026/05/20/elkhorn-contractor-again-accused-scamming-customer-writing-bad-checks-himself/" target="_blank" rel="noopener noreferrer">WOWT — Elkhorn Contractor Again Accused of Scamming Customer, Writing Bad Checks to Himself (Mark Schneidewind)</a></li>
              <li><a href="https://www.wowt.com/2026/04/30/roofer-pleads-no-contest-criminal-case-after-bilking-omaha-89-year-old/" target="_blank" rel="noopener noreferrer">WOWT — Roofer Pleads No Contest in Criminal Case After Bilking Omaha 89-Year-Old (Joshua Peterson)</a></li>
              <li><a href="https://nebraskalegislature.gov/laws/statutes.php?statute=28-512" target="_blank" rel="noopener noreferrer">Nebraska Revised Statute 28-512 (Theft by Deception, background)</a></li>
            </ul>
          </div>
