      ...
      <section className="value-props" style={{ paddingTop: 0 }}>
        <div className="container">
          <div className="about-prose article-body">
            ...
            <p>Two prosecutions illustrate the pattern. Mark Eugene Stargardt, doing business as Stargardt and Associates, was found guilty of grand theft for taking roughly $38,000 from an 87-year-old victim for reconstruction work that was never performed, and was sentenced to five years plus $46,606 in restitution. Separately, three Tampa-area men — Edward Newton, Christopher Mayes, and Christian Pantazonis — pleaded guilty to fraudulently contracting Panama City-area repairs and stealing roughly $319,000 in down payments.</p>
            ...
            <ul className="article-sources">
              <li><a href="https://www.wjhg.com/2026/07/16/tampa-contractor-sentenced-5-years-hurricane-michael-theft-case/" target="_blank" rel="noopener noreferrer">WJHG — Tampa Contractor Sentenced to 5 Years in Hurricane Michael Theft Case (Mark Eugene Stargardt)</a></li>
              <li><a href="https://www.wjhg.com/2026/06/17/contractor-found-guilty-grand-theft-following-post-hurricane-michael-reconstruction/" target="_blank" rel="noopener noreferrer">WJHG — Contractor Found Guilty of Grand Theft Following Post-Hurricane Michael Reconstruction</a></li>
              <li><a href="https://sa14.fl.gov/2019/01/04/construction-fraud-task-force-update/" target="_blank" rel="noopener noreferrer">14th Judicial Circuit State Attorney's Office — Construction Fraud Task Force Update</a></li>
              <li><a href="http://www.leg.state.fl.us/statutes/index.cfm?App_mode=Display_Statute&URL=0400-0499/0489/Sections/0489.126.html" target="_blank" rel="noopener noreferrer">Florida Statutes §489.126 – Moneys Received by Contractors (background)</a></li>
            </ul>
          </div>
