    ...
    <>
      ...
      <section className="hero" style={{ paddingBottom: 40, paddingTop: 120 }}>
        <div className="container hero-content">
          ...
          <h1>The Wichita Contractor Ordered to Pay Over $500,000 After Taking Homeowner Deposits</h1>
          <p className="hero-subtitle">Chad E. Smith, a Wichita-area contractor, collected large deposits from homeowners for remodeling and construction projects, then failed to complete the work or refund the money — while falsely claiming to be a licensed general contractor. He was convicted on 25 counts and ordered to pay over $500,000 in restitution.</p>
        </div>
      </section>
      ...
      <section className="value-props" style={{ paddingTop: 0 }}>
        <div className="container">
          <div className="about-prose article-body">
            ...
            <p>Chad E. Smith, a Wichita-area contractor, was convicted on 25 counts — including theft by deception, deceptive commercial practice, mistreatment of a dependent adult, and forgery — after authorities alleged he collected substantial upfront deposits from homeowners for remodeling and construction projects, then failed to complete the work or return the money, while falsely representing himself as a licensed general contractor. He was sentenced to 85 months (just over seven years) and ordered to pay more than $500,000 in restitution.</p>
            ...
            <p>By the time law enforcement became involved, the pattern spanned numerous victims. Prosecutors in Sedgwick County pursued felony charges reflecting the cumulative restitution figure exceeding $500,000. Under Kansas law, theft of property valued at $100,000 or more is a severity level 5 nonperson felony, carrying potential prison time and restitution obligations.</p>
            ...
            <ul className="article-sources">
              <li><a href="https://www.kake.com/home/wichita-contractor-sentenced-to-7-years-for-taking-money-not-completing-work/article_493a6a32-cd84-441b-9099-91465c9e599f.html" target="_blank" rel="noopener noreferrer">KAKE — Wichita Contractor Sentenced to 7 Years for Taking Money, Not Completing Work</a></li>
              <li><a href="https://www.kwch.com/2026/08/24/da-wichita-contractor-who-didnt-complete-or-even-start-several-projects-faces-7-years-prison/" target="_blank" rel="noopener noreferrer">KWCH — DA: Wichita Contractor Who Didn't Complete or Even Start Several Projects Faces 7 Years</a></li>
              <li><a href="https://www.ksrevisor.org/statutes/chapters/ch21/021_058_0001.html" target="_blank" rel="noopener noreferrer">Kansas Statutes Annotated 21-5801 (Theft, background)</a></li>
            </ul>
          </div>
