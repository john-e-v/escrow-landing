    ...
    <>
      ...
      <section className="hero" style={{ paddingBottom: 40, paddingTop: 120 }}>
        <div className="container hero-content">
          ...
          <h1>The Atlanta Pool Builder Who Left Homeowners With Empty Yards and Drained Deposits</h1>
          <p className="hero-subtitle">Rick McDermott's Aqua Blue Pools collected large deposits from homeowners across metro Atlanta but left projects unfinished or never started. Prosecutors charged him after families across multiple counties lost their money to abandoned pool construction contracts.</p>
        </div>
      </section>
      ...
      <section className="value-props" style={{ paddingTop: 0 }}>
        <div className="container">
          <div className="about-prose article-body">
            ...
            <p>In 2022, metro Atlanta homeowners who dreamed of backyard swimming pools found themselves at the center of a sprawling consumer fraud case. Rick McDermott, owner of Roswell-based Aqua Blue Pools, had collected substantial up-front deposits from numerous customers for in-ground pools, yet many of those projects were never completed and some were never started at all. At least five families reported losing roughly $300,000 combined, with additional Forsyth County charges covering over $139,000 more from two other homeowners — and the company shut down amid a bankruptcy filing as further complaints came in.</p>
            ...
            <p>McDermott was arrested and charged with conversion of payments for real property improvements — a Georgia statute aimed specifically at contractors who take construction funds and use them for something other than the job they were paid for.</p>
            ...
            <ul className="article-sources">
              <li><a href="https://www.fox5atlanta.com/news/embattled-pool-company-owner-arrested-over-co-mingling-funds" target="_blank" rel="noopener noreferrer">FOX 5 Atlanta — Embattled Pool Company Owner Arrested Over Co-Mingling Funds (Rick McDermott / Aqua Blue Pools)</a></li>
              <li><a href="https://www.forsythnews.com/news/crime-courts/roswell-man-indicted-over-unbuilt-pools-in-forsyth-county-enters-plea-in-court/" target="_blank" rel="noopener noreferrer">Forsyth County News — Roswell Man Indicted Over Unbuilt Pools in Forsyth County Enters Plea</a></li>
              <li><a href="https://www.forsythnews.com/news/crime-courts/owner-of-bankrupt-pool-company-faces-new-felony-charges-over-unbuilt-pools-in-forsyth-county/" target="_blank" rel="noopener noreferrer">Forsyth County News — Owner of Bankrupt Pool Company Faces New Felony Charges</a></li>
              <li><a href="https://consumer.georgia.gov/" target="_blank" rel="noopener noreferrer">Georgia Office of the Attorney General — Consumer Protection Division (background)</a></li>
            </ul>
          </div>
