    ...
    <>
      ...
      <section className="hero" style={{ paddingBottom: 40, paddingTop: 120 }}>
        <div className="container hero-content">
          ...
          <h1>The Bonney Lake Contractor Who Took Approaching $1M From Homeowners</h1>
          <p className="hero-subtitle">Construction Kings, based in Bonney Lake, Washington, collected large deposits for home renovation and construction projects, then failed to complete the work. State regulators, local police, and a multistate federal probe pursued the case after 26 or more homeowners reported losses.</p>
        </div>
      </section>
      ...
      <section className="value-props" style={{ paddingTop: 0 }}>
        <div className="container">
          <div className="about-prose article-body">
            ...
            <p>In 2023, Washington State authorities took action against Construction Kings, a Bonney Lake-based residential contractor, after a wave of homeowner complaints described a familiar and painful pattern: sizable upfront deposits collected for renovation and new-construction projects, followed by work that was abandoned midway or never begun at all. The company drew 26 or more complaints to the state Department of Labor & Industries, multiple Bonney Lake police investigations, and a federal multistate probe into an operation targeting Pacific Northwest homeowners — with reported losses approaching $1 million among the homeowners interviewed by investigators.</p>
            ...
            <ul className="article-sources">
              <li><a href="https://www.rcaw.com/bonney-lake-contractor-faces-million-dollar-fraud-charges/" target="_blank" rel="noopener noreferrer">Roofing Contractors Association of Washington — Bonney Lake Contractor Faces Million Dollar Fraud Charges (Construction Kings)</a></li>
              <li><a href="https://www.fox13seattle.com/news/pierce-county-construction-scam" target="_blank" rel="noopener noreferrer">FOX 13 Seattle — Pierce County Construction Scam Claims More Victims</a></li>
              <li><a href="https://app.leg.wa.gov/rcw/default.aspx?cite=18.27" target="_blank" rel="noopener noreferrer">RCW 18.27 — Registration of Contractors (bond requirements, background)</a></li>
            </ul>
          </div>
