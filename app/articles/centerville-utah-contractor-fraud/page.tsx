    ...
    <>
      ...
      <section className="hero" style={{ paddingBottom: 40, paddingTop: 120 }}>
        <div className="container hero-content">
          ...
          <h1>The Centerville Contractor Who Took Over $400,000 From Homeowners</h1>
          <p className="hero-subtitle">Edson Lins, an unlicensed Centerville, Utah contractor, collected large deposits for home construction and remodeling projects, then failed to complete the work, leaving families out hundreds of thousands of dollars. State prosecutors charged him with multiple felony counts after homeowner complaints mounted.</p>
        </div>
      </section>
      ...
      <section className="value-props" style={{ paddingTop: 0 }}>
        <div className="container">
          <div className="about-prose article-body">
            ...
            <p>Prosecutors in Utah's 3rd District Court filed felony charges against Edson Lins, an unlicensed Centerville contractor, accused of collecting more than $400,000 in deposits from multiple homeowners for construction and remodeling projects, then abandoning the work and failing to return the money. The case, which drew the attention of the Utah Division of Occupational and Professional Licensing (DOPL) and local law enforcement, illustrates a recurring pattern in residential construction fraud: money changes hands up front, work stalls, and homeowners are left with unfinished projects and little legal recourse.</p>
            <p>The charges included second-degree felony counts of theft, communications fraud, unlawful use of a bank card, and a pattern of unlawful activity — a statute Utah prosecutors use when a defendant engages in three or more related criminal acts. Prosecutors alleged Lins solicited large deposits, began minimal or no work, and then stopped communicating with clients while keeping the funds.</p>
            ...
            <p>Because the alleged conduct involved multiple victims and repeated transactions, prosecutors elevated the matter beyond simple breach of contract, framing it as a coordinated pattern of theft rather than isolated business failures. Additional charges followed as more victims came forward describing the same pattern: money taken, no work performed, no license to begin with.</p>
            ...
            <ul className="article-sources">
              <li><a href="https://www.ksl.com/article/51193357/contractor-with-no-license-accused-of-pocketing-hundreds-of-thousands-" target="_blank" rel="noopener noreferrer">KSL.com — Contractor With No License Accused of Pocketing Hundreds of Thousands (Edson Lins)</a></li>
              <li><a href="https://www.ksl.com/article/51313612/unlicensed-contractor-faces-more-charges-accusing-him-of-taking-money-but-not-doing-work" target="_blank" rel="noopener noreferrer">KSL.com — Unlicensed Contractor Faces More Charges Accusing Him of Taking Money but Not Doing Work</a></li>
              <li><a href="https://dopl.utah.gov" target="_blank" rel="noopener noreferrer">Utah Division of Occupational and Professional Licensing (DOPL, background)</a></li>
              <li><a href="https://le.utah.gov/xcode/Title76/Chapter10/76-10-S1603.html" target="_blank" rel="noopener noreferrer">Utah Code — Pattern of Unlawful Activity Act (background)</a></li>
            </ul>
          </div>
